...
namespace WebApiClientCore.Extensions.OAuths
{
    ...
    public class DefaultPasswordCredentialsTokenClient : IPasswordCredentialsTokenClient
    {
        ...
        /// 选项
        /// </summary>
        private readonly IOptionsMonitor<PasswordCredentialsOptions> optionsMonitor;

        /// <summary>
        /// password授权模式的Token客户端
        /// </summary>
        /// <param name="clientApi">OAuth客户端接口</param> 
        /// <param name="optionsMonitor">选项</param>
        public DefaultPasswordCredentialsTokenClient(
            ITokenClientApi clientApi,
            IOptionsMonitor<PasswordCredentialsOptions> optionsMonitor)
        {
