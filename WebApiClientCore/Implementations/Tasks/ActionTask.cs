...
namespace WebApiClientCore.Implementations.Tasks
{
    ...
    {
        private readonly DefaultApiActionInvoker<TResult> invoker;
        ...
        public ActionTask(DefaultApiActionInvoker<TResult> invoker, HttpClientContext context, object?[] arguments)
        {
